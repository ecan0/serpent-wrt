...
serpent-wrt --config /etc/serpent-wrt/serpent-wrt.yaml feed validate | grep -q "feed OK"
serpent-wrt --config /etc/serpent-wrt/serpent-wrt.yaml feed add 198.51.100.1 | grep -q "added"
serpent-wrt --config /etc/serpent-wrt/serpent-wrt.yaml feed list | grep -q "198.51.100.1"
serpent-wrt --config /etc/serpent-wrt/serpent-wrt.yaml feed remove 198.51.100.1 | grep -q "removed"
